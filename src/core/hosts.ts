...
export const HOST: Record<HostKind, HostInfo> = {
  ...
  miser: { ko: '인색한 유지', short: '유지', prize: 0.8, rent: 0.9, missio: 0.15, rudis: 0, fameWin: 0, honorAll: 0, bet: false, desc: '돈이 없는 지방 유지. 사망 배상이 두려워 살려 주는 편이지만 상금과 대여료를 깎는다.' },
  ...
  imperial: { ko: '황제의 경기', short: '황제', prize: 1.5, rent: 1.1, missio: -0.25, rudis: 0.2, fameWin: 2, honorAll: 0, bet: false, desc: '황제나 총독이 여는 대규모 경기. 상금·호감도·루디스가 가장 크지만 자비가 없다.' },
};
