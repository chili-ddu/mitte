...
export const SKILLS: SkillDef[] = [
  ...
  { id: 'shield_bash', name: '방패치기', types: ['murmillo', 'secutor', 'provocator'], base: 0.30, desc: '방패로 막았을 때 발동하면 상대를 0.5초 비틀거리게 한다.', learn: '경험: 한 경기에서 3번 막아낸 뒤' },
  { id: 'riposte', name: '되치기', types: 'all', base: 0.30, desc: '막은 직후 발동하면 즉시 반격한다(공격력 80%).', learn: '경험: 막고 나서 이긴 경기' },
  { id: 'twin_cut', name: '이중베기', types: ['thraex', 'dimachaerus'], base: 0.15, desc: '연속 공격 확률 +15%.', learn: '경험: 연속 공격으로 상대를 쓰러뜨린 뒤' },
  { id: 'net_recover', name: '그물회수', types: ['retiarius'], base: 0.30, desc: '던진 그물을 거둬 경기 중 한 번 더 던진다.', learn: '경험: 그물로 묶은 상대를 쓰러뜨린 뒤' },
  { id: 'spear_ward', name: '창견제', types: ['hoplomachus', 'eques'], base: 0.30, desc: '근접한 적이 공격하려 할 때 발동하면 창으로 밀어내 그 공격을 무산시킨다.', learn: '경험: 근접 유형을 이긴 뒤' },
  { id: 'stand_firm', name: '버티기', types: 'all', base: 0.35, desc: 'HP 30% 아래에서 맞을 때 발동하면 피해 −25%.', learn: '경험: HP 20% 아래에서 살아남은 뒤' },
  { id: 'second_wind', name: '숨고르기', types: 'all', base: 0.50, desc: '경기 중 한 번, HP 25% 아래로 떨어질 때 발동하면 심판(수마 루디스)이 잠시 경기를 멈춘다: 2초 동안 공격받지 않고 거리를 벌리며 최대 HP의 5%를 회복.', learn: '경험: HP 20% 아래에서 살아남은 뒤' },
  { id: 'appeal', name: '관중호소', types: 'all', base: 0.60, desc: '쓰러졌을 때 발동하면 검지를 높이 들어 미시오 확률 +5%.', learn: '경험: 미시오로 살아난 뒤' },
  { id: 'charge_plus', name: '돌진강화', types: ['hoplomachus', 'eques', 'secutor'], base: 0.30, desc: '돌진 공격 때 발동하면 피해 ×1.3.', learn: '경험: 돌진 공격으로 상대를 쓰러뜨린 뒤' },
];
