...
export const CONFIG = {
  ...
  healCost: 500,
  trainHpGain: [6, 12] as const, // 체력 훈련 상승폭 범위(무작위): 공·방 +1 의 값(전력식 4.5)을 가운데 두고 위아래로 (2026-09-17 사용자: 고정 말고 범위로)
  ...
  disarm: { chance: 0.022, windedMul: 2, sec: 1.8, atkMul: 0.5, pugioMul: 0.78, dist: 70 }, // 무기 떨구기(2026-09-17): 막거나 받아넘긴 손에 큰 충격이 오면 무기를 놓친다. 지쳤으면 확률 ×windedMul. 놓친 동안 공격력 ×atkMul(레티아리우스는 허리에 단검(푸기오)이 있어 ×pugioMul), sec 초 뒤 주워 든다. 무기는 dist 만큼 날아가 떨어진다 — 줍는 동안이 반전의 틈
